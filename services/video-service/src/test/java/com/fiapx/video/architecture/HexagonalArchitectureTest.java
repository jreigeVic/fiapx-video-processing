package com.fiapx.video.architecture;
 ...
 * docs/LLD/video-service.md. Fails the build (via the normal {@code test} task) on violation.
 */
@AnalyzeClasses(packages = "com.fiapx.video")
