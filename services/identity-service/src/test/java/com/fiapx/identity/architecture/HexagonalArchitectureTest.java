package com.fiapx.identity.architecture;
 ...
 * docs/LLD/identity-service.md. Fails the build (via the normal {@code test} task) on violation.
 */
@AnalyzeClasses(packages = "com.fiapx.identity")
